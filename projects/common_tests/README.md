...
### Linking
From the [common_tests subproject folder](.), it’s possible to link all contracts with:
```bash
...
### Testing
From the [common_tests subproject folder](.), it’s possible to test all libraries with:
```bash
