...
from smart_contracts.artifacts.lib_pcg64_test_harness_ts import (
    LibPcg64TestHarnessTsClient,
    LibPcg64TestHarnessTsFactory,
)
...
class LibPCG64TestHarnessAdapter(ILibPCG64TestHarnessAdapter):
    app_client: LibPcg64TestHarnessTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg64TestHarnessTsFactory(algorand_client, default_sender=deployer.address).deploy(
