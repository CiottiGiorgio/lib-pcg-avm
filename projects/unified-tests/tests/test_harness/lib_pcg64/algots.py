...
from smart_contracts.artifacts.lib_pcg64_test_harness_algo_ts import (
    LibPcg64TestHarnessAlgoTsClient,
    LibPcg64TestHarnessAlgoTsFactory,
)
...
class LibPCG64TestHarnessAdapter(ILibPCG64TestHarnessAdapter):
    app_client: LibPcg64TestHarnessAlgoTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg64TestHarnessAlgoTsFactory(algorand_client, default_sender=deployer.address).deploy(
