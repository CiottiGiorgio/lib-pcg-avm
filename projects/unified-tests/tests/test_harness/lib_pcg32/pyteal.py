...
from smart_contracts.artifacts.lib_pcg32_test_harness_pyteal import (
    LibPcg32TestHarnessPytealClient,
    LibPcg32TestHarnessPytealFactory,
)
...
class LibPCG32TestHarnessAdapter(ILibPCG32TestHarnessAdapter):
    app_client: LibPcg32TestHarnessPytealClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg32TestHarnessPytealFactory(algorand_client, default_sender=deployer.address).deploy(
