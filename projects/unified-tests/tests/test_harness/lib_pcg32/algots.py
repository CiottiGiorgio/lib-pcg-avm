...
from smart_contracts.artifacts.lib_pcg32_test_harness_algo_ts import (
    LibPcg32TestHarnessAlgoTsClient,
    LibPcg32TestHarnessAlgoTsFactory,
)
...
class LibPCG32TestHarnessAdapter(ILibPCG32TestHarnessAdapter):
    app_client: LibPcg32TestHarnessAlgoTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg32TestHarnessAlgoTsFactory(algorand_client, default_sender=deployer.address).deploy(
