...
from smart_contracts.artifacts.lib_pcg32_test_harness_ts import (
    LibPcg32TestHarnessTsClient,
    LibPcg32TestHarnessTsFactory,
)
...
class LibPCG32TestHarnessAdapter(ILibPCG32TestHarnessAdapter):
    app_client: LibPcg32TestHarnessTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg32TestHarnessTsFactory(algorand_client, default_sender=deployer.address).deploy(
