...
from smart_contracts.artifacts.lib_pcg128_test_harness_algo_ts import (
    LibPcg128TestHarnessAlgoTsClient,
    LibPcg128TestHarnessAlgoTsFactory,
)
...
class LibPCG128TestHarnessAdapter(ILibPCG128TestHarnessAdapter):
    app_client: LibPcg128TestHarnessAlgoTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg128TestHarnessAlgoTsFactory(algorand_client, default_sender=deployer.address).deploy(
    ...
    def get_pcg128_sequence_arc4_uint128_return(
        ...
        return (
            ...
            .get_pcg128_sequence_arc4_uint128_return((seed, lower_bound, upper_bound, length))
