...
from smart_contracts.artifacts.lib_pcg128_test_harness_ts import (
    LibPcg128TestHarnessTsClient,
    LibPcg128TestHarnessTsFactory,
)
...
class LibPCG128TestHarnessAdapter(ILibPCG128TestHarnessAdapter):
    app_client: LibPcg128TestHarnessTsClient

    def deploy(self, algorand_client: AlgorandClient, deployer: SigningAccount) -> None:
        self.app_client, _ = LibPcg128TestHarnessTsFactory(algorand_client, default_sender=deployer.address).deploy(
