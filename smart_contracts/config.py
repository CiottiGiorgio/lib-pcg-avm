...
def has_contract_file(directory: Path) -> bool:
    """Checks whether the directory contains xsh_rr_64_32.py file."""
...
## manually otherwise the above code will always include all contracts under xsh_rr_64_32.py file for any subdirectory
